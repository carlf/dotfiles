...
* Pretty things up a little
  Lots of stuff in here. Loading the solarized-dark theme, turning off
  most of the UI, turning on smart-mode-line, and disabling the
...
* Load magit
  Magit is mandatory. Don't leave home without it.
#+BEGIN_SRC emacs-lisp
  (use-package magit
    :ensure t
...
* Load smartparens
  Smartparens in strict mode makes like with lisp and lispy things
  much nicer. No more wondering if your braces are matched. It's
  impossible to unbalance them.
#+BEGIN_SRC emacs-lisp
